...
manual_base_path = "tt_dims2_dimtypes_only"
dimtype_dir = os.path.join(manual_base_path, "data", "tt_dims2", "dimension_type")
...
manual_zip_path = "tt_dims2_dimtypes_only.zip"
